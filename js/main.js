                        ...
                        if(talk){
                            ...
                            <div class="top-left col-xs-12 col-sm-4">
                                ...
                                <div class="btn-1 col-xs-12 col-sm-12" >
                                    <button type="button" class="btn-2 header2 btn btn-info"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> 已收藏</button>
                            ...
                            $('.btn-2').click(function(){
                                    $.ajax({ //jQuery中的ajax方法
                                        ...
                                        success: function (data) {//如果成功获得了值执行的方法，目的是为了让用户知道执行的操作成功了。
                                            if(data){
                                                $('.btn-2').addClass('header2');
                                                $('.btn-2').html('<span class="glyphicon glyphicon-heart" aria-hidden="true"></span> 已收藏')
                                            }
